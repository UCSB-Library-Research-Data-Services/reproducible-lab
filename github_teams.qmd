...
Once the repository created, click on the _Settings_ tab (top right in the grey bar)

![](img/github_org_collaborators-03_repo_created.png){fig-align="center" width=90%}

{fig-align="center" width=70%}On the left panel, click on _Collaborators and teams_ and then click on the green button _Add teams_
